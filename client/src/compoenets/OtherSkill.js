...
import backIcon from "../compoenets/image/icons/ket2.png";
...
const OtherSkills = () => (
    <Animated animationIn="fadeInRightBig" animationOut="zoomOutDown" isVisible={true}>
        <article className="mw5 mh2 bg-white br3 pa3 pa4-ns mv3 ba b--black-10">
            <div className="tc">
                <h2><img src={backIcon} style={styles.icon} alt='other skills logo'/>
                Other</h2>
                ...
                <div>
                    ...
                    <a className="f4 fw6 db black link hover-hot-pink pv1">Responsive Design</a>     
                    ...
                    <a className="f4 fw6 db black link hover-hot-pink pv1">Balsamiq Mockups</a>      
                </div>
        </article>
  </Animated>
)
